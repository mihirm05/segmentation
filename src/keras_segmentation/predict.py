...
def get_legends(class_names, colors=class_colors):
    ...
    for col in class_colors:
        if col == (148, 15, 107):
            sorted_class_names.append("Others")

        elif col == (131, 24, 203):
            sorted_class_names.append("Obstacle")

        elif col == (192, 68, 41):
            sorted_class_names.append("Grass")

        elif col == (236, 3, 124):
            sorted_class_names.append("Forest Floor")

        elif col == (13, 37, 81):
            sorted_class_names.append("Sky")

        elif col == (205, 178, 34):
            sorted_class_names.append("Tree")
    '''
...
def overlay_seg_image(inp_img, seg_img):
    ...
    # originally average of both the images were considered
    fused_img = (inp_img / 4 + 3*seg_img / 4).astype('uint8')
    return fused_img
